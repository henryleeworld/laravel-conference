...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ trans('global.create') }} {{ trans('cruds.speaker.title_singular') }}</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route("admin.speakers.store") }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 {{ $errors->has('twitter') ? 'has-error' : '' }}">
                            ...
                            <div class="mb-3 {{ $errors->has('facebook') ? 'has-error' : '' }}">
                            ...
                            <div class="mb-3 {{ $errors->has('linkedin') ? 'has-error' : '' }}">
