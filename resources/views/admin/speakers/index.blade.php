...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ trans('cruds.speaker.title_singular') }} {{ trans('global.list') }}</h1>
                @can('speaker_create')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
		                    <table class=" table table-bordered table-striped table-hover datatable datatable-Speaker" style="width:100%">
                                <thead>
                                    <tr>
                                        <th width="10">
