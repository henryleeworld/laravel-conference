...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ trans('global.create') }} {{ trans('cruds.schedule.title_singular') }}</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route("admin.schedules.store") }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 {{ $errors->has('day_number') ? 'has-error' : '' }}">
                            ...
                            <div class="mb-3 {{ $errors->has('start_time') ? 'has-error' : '' }}">
                            ...
                            <div class="mb-3 {{ $errors->has('subtitle') ? 'has-error' : '' }}">
                            ...
                            <div class="mb-3 {{ $errors->has('speaker_id') ? 'has-error' : '' }}">
